...
# source ~/vault/v_git/dot-files/init.zsh

# Dot files zsh
for file in ~/vault/v_git/dot-files/dot-files/zsh/common/*.zsh; do
  source "$file"
done
...
# Functions
for file in ~/vault/v_git/dot-files/dot-files/scripts/common/*.sh; do
  source "$file"
done
