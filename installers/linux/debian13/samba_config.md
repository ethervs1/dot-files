# Configuración de Samba en Debian 13
...
**2. Montar la partición en /mnt/share:**
```bash
# Crear punto de montaje
mkdir -p /mnt/share

# Montar partición (reemplazar sdb3 con tu partición)
mount /dev/sdb3 /mnt/share
...
# UUID=xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx /mnt/share ext4 defaults,nofail 0 2
vim /etc/fstab
...
# Montar
mount -o loop /mnt/samba-volume.img /mnt/share
...
- Verificar permisos: `ls -ld /mnt/share`
- Debe ser accesible: `chmod 755 /mnt/share`
- Verificar usuario: `ls -lh /mnt/share`
...
| `path` | /mnt/share | Ruta del directorio a compartir |
